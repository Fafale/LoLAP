...
class TotalCheckAmount(Range):
    """
    What percentage of total checks are needed to win?
    """
    default = 80
    range_start = 30
    range_end = 100
    display_name = "Required Check Percentage"
...
class LOLOptions(PerGameCommonOptions):
    ...
    total_check_amount: TotalCheckAmount