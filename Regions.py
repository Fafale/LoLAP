...
def create_regions(multiworld: MultiWorld, player: int, options, possible_champions):
    ...
    for champion_id in champions:
        ...
        if champion_name in possible_champions:
            ...
            regions["Match"].locations.append(champion_name + " - Assist Taking Atakhan")
            ...
            regions["Match"].locations.append(champion_name + " - Check - Dragon")
            regions["Match"].locations.append(champion_name + " - Check - Rift Herald")
            regions["Match"].locations.append(champion_name + " - Check - Baron")
            regions["Match"].locations.append(champion_name + " - Check - Atakhan")
            regions["Match"].locations.append(champion_name + " - Check - Tower")
            regions["Match"].locations.append(champion_name + " - Check - Inhibitor")
